...
extern touchgfx::GeneratedFont& getFont_verdanaz_14_4bpp();
extern touchgfx::GeneratedFont& getFont_verdanai_17_4bpp();
extern touchgfx::GeneratedFont& getFont_verdanai_16_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_verdanaz_20_4bpp()),
    &(getFont_verdana_40_4bpp()),
    &(getFont_verdanaz_14_4bpp()),
    &(getFont_verdanai_17_4bpp()),
    &(getFont_verdanai_16_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_verdanaz_20_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_verdana_40_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_verdanaz_14_4bpp());
        break;
    case 3:
        touchgfx_fonts[3] = &(getFont_verdanai_17_4bpp());
        break;
    case 4:
        touchgfx_fonts[4] = &(getFont_verdanai_16_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
